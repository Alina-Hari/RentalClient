      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label className="input flex items-center gap-2">
            ...
            <input type="checkbox" className="checkbox checkbox-accent" id="isPetFriendly" name="isPetFriendly" checked={isAvailable}  onChange={handleisPetFriendly} />
          </label>
          <label>
          <DTPicker />
          </label>
          <button type="submit" className="btn btn-outline btn-accent rounded-md"> Edit </button>
        </form>
      </div >
    </div >
  );
